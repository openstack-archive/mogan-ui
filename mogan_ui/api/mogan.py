...
def server_create(request, name, image, flavor, nics, availability_zone,
    ...
    return server_manager.create(
        ...
        description=description, networks=networks,
        availability_zone=availability_zone, user_data=user_data,
        key_name=key_name, min_count=server_count, max_count=server_count,
    )
